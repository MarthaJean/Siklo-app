      ...
      <div class="announcements-view">
        ...
        <v-container fluid class="pa-0 mt-5">
          <v-row class="ma-0 mb-4">
            ...
            <v-col cols="12" md="4" class="pa-4 d-flex justify-center">
              <v-btn
                color="primary"
                variant="flat"
                size="large"
                  ...
                  >
                    ...
                    >
                      ...
                      <v-card-text class="pa-4">
                        ...
                        <p
                          class="text-body-2 text-medium-emphasis line-clamp-3 mb-3"
                        >
                        ...
                        >
                          ...
                          <v-chip
                            :color="
                              announcement.image_url ? 'success' : 'secondary'
                            "
                            variant="tonal"
                            size="x-small"
                          >
        ...
        >
          ...
          <template v-slot:actions>
            <v-btn
              @click="announcementsStore.clearError"
              variant="text"
              color="white"
            >
              Close
...
const deleteAnnouncement = (id: number) => {
  ...
  announcementToDelete.value = announcementsStore.announcements.find(
    (a) => a.id === id,
  );
  deleteId.value = id;
...
const handleScroll = () => {
  ...
  infiniteScrollTimeout = setTimeout(() => {
    ...
    if (scrollTop + clientHeight >= scrollHeight - 300) {
      if (
        announcementsStore.hasMore &&
        !announcementsStore.loadingMore &&
        !searchQuery.value
      ) {
